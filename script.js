...
timelineDay
    ...
    .to('.city', 3, {y: 120}, '-=3')
    .to('.sun', 3, {y: 400, x: -80, opacity: 0.1}, '-=3')
...
timelineEvening
    .fromTo('.clouds-evening', 3, {opacity: 0, y: -150}, {opacity: 1, y: 60})
    .fromTo('.mountains', 3, {y: -50}, {y: 25}, '-=3')
    .fromTo('.bg2', 2, {y: 0}, {y: -300}, '-=3')
    .fromTo('.evening-title', 3, {opacity: 0, scale: 0.5}, {opacity: 1, scale: 1}, '-=3')
...
//timelineCloud.to('.day', duration, {css:{backgroundPosition:endPosition + "px 0"}, repeat:-1, ease:Linear.easeNone})